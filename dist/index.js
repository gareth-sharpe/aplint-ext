...
const open_1 = __webpack_require__(23);
...
Object.defineProperty(exports, "__esModule", { value: true });
const vscode_1 = __webpack_require__(1);
const exec_1 = __webpack_require__(3);
const parse_1 = __webpack_require__(6);
const lint_1 = __webpack_require__(14);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
const diagnostics_1 = __webpack_require__(7);
...
exports.PRIORITY = 3;
exports.LINE = 4;
exports.DESCRIPTION = 5;
exports.RULE_SET = 6;
exports.RULE = 7;
// Rule Sets
exports.CODE_STYLE = 'Manulife';
// Rule Descriptions
...
exports.VARIABLES_MUST_BE_FORMATED_DESCRIPTION = 'Variables in paranthases must have consistent spacing';
exports.SPACE_MUST_FOLLOW_COMMA_DESCRIPTION = 'Space must follow a comma and comma must not follow a space';
exports.LOOPS_MUST_HAVE_FORMATTED_SPACING_DESCRIPTION = 'Loops must have formatted spacing';
exports.MUST_NOT_HAVE_EXTRA_SPACING_DESCRIPTION = 'Code must not have extra spacing';
// Rule Names
exports.BRACES_MUST_BE_FORMATTED_RULE = 'BracesMustBeFormatted';
exports.PARANTHASES_MUST_BE_FORMATTED_RULE = 'ParanthasesMustBeFormatted';
exports.VARIABLES_MUST_BE_FORMATED_RULE = 'VaraiblesMustBeFormatted';
exports.SPACE_MUST_FOLLOW_COMMA_RULE = 'SpaceMustFollowComma';
exports.LOOPS_MUST_HAVE_FORMATTED_SPACING_RULE = 'LoopsMustHaveFormattedSpacing';
exports.MUST_NOT_HAVE_EXTRA_SPACING_RULE = 'MustNotHaveExtraSpacing';
...
var Streamer = __webpack_require__(12);
...
Streamer.prototype._transform = function(chunk, encoding, done) {
  ...
  if (this.sep === undefined) {
    // try to detect the separator if not provided
    this.sep = __webpack_require__(10).detect(this.buffer);
  }
...
const paranthasesMustBeFormatted_1 = __webpack_require__(17);
const variablesMustBeFormatted_1 = __webpack_require__(18);
const spaceMustFollowComma_1 = __webpack_require__(19);
const loopsMustHaveFormattedSpacing_1 = __webpack_require__(20);
const mustNotHaveExtraSpacing_1 = __webpack_require__(21);
const { createReadStream } = __webpack_require__(5);
const { createInterface } = __webpack_require__(22);
/**
 ...
 */
exports.lint = (path, map) => __awaiter(this, void 0, void 0, function* () {
    let allResults = [];
    yield new Promise((resolve, reject) => {
        ...
        rl.on('line', (line) => {
            ...
            const variableSpacingResults = variablesMustBeFormatted_1.lintForVariableSpacing(path, line, i);
            const braceSpacingResults = bracesMustBeformatted_1.lintForBraceSpacing(path, line, i);
            const parathaseSpacingResults = paranthasesMustBeFormatted_1.lintForParenthesesSpacing(path, line, i);
            const spaceAfterCommaResults = spaceMustFollowComma_1.lintForSpaceAfterComma(path, line, i);
            const loopsSpacingResults = loopsMustHaveFormattedSpacing_1.lintForLoopSpacing(path, line, i);
            const noExtraSpacing = mustNotHaveExtraSpacing_1.lintForExtraSpacing(path, line, i);
            allResults = allResults.concat(variableSpacingResults, classBraceSpacingresults, braceSpacingResults, parathaseSpacingResults, spaceAfterCommaResults, loopsSpacingResults, noExtraSpacing);
        });
        rl.on('close', resolve);
    });
...
Object.defineProperty(exports, "__esModule", { value: true });
const result_1 = __webpack_require__(16);
const constants_1 = __webpack_require__(8);
/**
 ...
 * @return {result}
 */
exports.lintForClassBraceSpacing = (file, line, i) => {
    ...
    if (!passesBracesMustHaveSpaceTest) {
        const result = result_1.makeResult(file, 3, i, constants_1.CODE_STYLE, constants_1.BRACES_MUST_BE_FORMATTED_DESCRIPTION, constants_1.BRACES_MUST_BE_FORMATTED_RULE);
        results.push(result);
    }
    return results;
};
 ...
 * @return {result}
 */
exports.lintForBraceSpacing = (file, line, i) => {
...
Object.defineProperty(exports, "__esModule", { value: true });
const constants_1 = __webpack_require__(8);
exports.makeResult = (file, priority, line, ruleset, description, rule) => {
    const result = {
        [constants_1.FILE]: file,
        [constants_1.PRIORITY]: priority,
        [constants_1.LINE]: line,
        [constants_1.DESCRIPTION]: description,
        [constants_1.RULE_SET]: ruleset,
        [constants_1.RULE]: rule,
    };
    return result;
};
...
Object.defineProperty(exports, "__esModule", { value: true });
const constants_1 = __webpack_require__(8);
const constants_2 = __webpack_require__(8);
/**
 ...
 * @return {result}
 */
exports.lintForParenthesesSpacing = (file, line, i) => {
    ...
    if (!passesParanthasesMustHaveSpaceTest) {
        const result = {
            [constants_1.FILE]: file,
            [constants_1.PRIORITY]: 3,
            [constants_1.LINE]: i,
            [constants_1.DESCRIPTION]: constants_2.PARANTHASES_MUST_BE_FORMATTED_DESCRIPTION,
            [constants_1.RULE_SET]: constants_2.CODE_STYLE,
            [constants_1.RULE]: constants_2.PARANTHASES_MUST_BE_FORMATTED_RULE,
        };
        results.push(result);
    }
    return results;
 ...
 * @return {result}
 */
exports.lintForVariableSpacing = (file, line, i) => {
    ...
    if (!passesVariablesMustHaveSpaceTest) {
        const result = {
            ...
            [constants_1.PRIORITY]: 3,
            [constants_1.LINE]: i,
            [constants_1.DESCRIPTION]: constants_2.VARIABLES_MUST_BE_FORMATED_DESCRIPTION,
            [constants_1.RULE_SET]: constants_2.CODE_STYLE,
            [constants_1.RULE]: constants_2.VARIABLES_MUST_BE_FORMATED_RULE,
        };
        results.push(result);
    }
    return results;
 ...
 * @return {result}
 */
exports.lintForSpaceAfterComma = (file, line, i) => {
    ...
    if (failsSpaceMustFollowCommaTest) {
        const result = {
            ...
            [constants_1.PRIORITY]: 3,
            [constants_1.LINE]: i,
            [constants_1.DESCRIPTION]: constants_2.SPACE_MUST_FOLLOW_COMMA_DESCRIPTION,
            [constants_1.RULE_SET]: constants_2.CODE_STYLE,
            [constants_1.RULE]: constants_2.SPACE_MUST_FOLLOW_COMMA_RULE,
        };
        results.push(result);
    }
    return results;
 ...
 * @return {result}
 */
exports.lintForLoopSpacing = (file, line, i) => {
    const isClassInstantiation = /\(.*\)[;]/g;
    ...
    if (failsLoopsMustHaveformattedSpacingTest) {
        const result = {
            ...
            [constants_1.PRIORITY]: 3,
            [constants_1.LINE]: i,
            [constants_1.DESCRIPTION]: constants_2.LOOPS_MUST_HAVE_FORMATTED_SPACING_DESCRIPTION,
            [constants_1.RULE_SET]: constants_2.CODE_STYLE,
            [constants_1.RULE]: constants_2.LOOPS_MUST_HAVE_FORMATTED_SPACING_RULE,
        };
        results.push(result);
    }
 ...
 * @return {result}
 */
exports.lintForExtraSpacing = (file, line, i) => {
    ...
    if (failsMustNotHaveExtraSpacing) {
        const result = {
            ...
            [constants_1.PRIORITY]: 3,
            [constants_1.LINE]: i,
            [constants_1.DESCRIPTION]: constants_2.MUST_NOT_HAVE_EXTRA_SPACING_DESCRIPTION,
            [constants_1.RULE_SET]: constants_2.CODE_STYLE,
            [constants_1.RULE]: constants_2.MUST_NOT_HAVE_EXTRA_SPACING_RULE,
        };
        results.push(result);
    }
    return results;
...
Object.defineProperty(exports, "__esModule", { value: true });
const vscode_1 = __webpack_require__(1);
const marked = __webpack_require__(24);
const fetch = __webpack_require__(25).default;
const NOT_FOUND = -1;
/**
 ...
 * @async
 */
exports.openRule = (diagnostic) => __awaiter(this, void 0, void 0, function* () {
    const panel = vscode_1.window.createWebviewPanel('aplint', 'Rule Description', vscode_1.ViewColumn.Two);
...
/* harmony import */ var stream__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(26);
/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(27);
...
class DocumentationProvider {
    ...
    provideCodeActions(document, range) {
        ...
        const aplitDiagnostics = diagnostics.filter((diagnostic) => diagnostic.source === 'APLint');
        if (!aplitDiagnostics.length) {
            return;
        }
        const anchoredDiagnostic = aplitDiagnostics.filter((diagnostic) => diagnostic.range.contains(range));
        if (!anchoredDiagnostic.length) {
            return;
        }
     ...
     * @returns {CodeAction}
     */
    openDocumentation(diagnostic) {
        const fix = new vscode_1.CodeAction('Open rule documentation', vscode_1.CodeActionKind.QuickFix);
        fix.command = {
...
DocumentationProvider.providedCodeActionKinds = [
