...
const { createInterface } = __webpack_require__(21);
/**
...
exports.lintForParenthesesSpacing = (file, line, i) => {
    ...
    if (!passesParanthesesMustHaveSpaceTest) {
        const result = {
            ...
            [constants_1.LINE]: i,
            [constants_1.DESCRIPTION]: constants_2.PARANTHESES_MUST_BE_FORMATTED_DESCRIPTION,
            [constants_1.RULE_SET]: constants_2.CODE_STYLE,
            [constants_1.RULE]: constants_2.PARANTHESES_MUST_BE_FORMATTED_RULE,
        };
        results.push(result);
    }
    return results;
...
Object.defineProperty(exports, "__esModule", { value: true });
const vscode_1 = __webpack_require__(1);
const marked = __webpack_require__(23);
const fetch = __webpack_require__(24).default;
const NOT_FOUND = -1;
/**
